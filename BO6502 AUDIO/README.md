...
To interact with the sound chips, the software must manipulate the address bits $A0$ and $A1$ while selecting the desired channel via $A2$.

* **Select PSG 1 (Left):** Access addresses where $A2=0$ (e.g., `$D1C0`, `$D1C1`, etc.).
* **Select PSG 2 (Right):** Access addresses where $A2=1$ (e.g., `$D1C4`, `$D1C5`, etc.).
