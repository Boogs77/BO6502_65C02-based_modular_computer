...
* **LCD Display:** Interface for standard 16x2 modules (HD44780 controller) using pins **PB0-PB6** for the data bus.
* **Keyboard Interface:** 5-pin DIN input (X1) interfaced to VIA pins **PA0-PA7** via shift logic.
