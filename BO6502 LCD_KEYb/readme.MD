...
* [cite_start]**Keyboard Interface:** 5-pin DIN input (X1) interfaced to VIA pins **PA0-PA1** via shift logic [cite: 8-10, 83-96].
* [cite_start]**Acquisition Logic:** Dual **74HCT595N** shift registers handle the serialization of keyboard data, synchronized by the `KB_CLK` signal and cleaned through **74HCT14N** Schmitt triggers [cite: 141-166, 208].
...
* [cite_start]**CA1:** Keyboard interrupt management (**KB_INT**) to signal the CPU when new data is available[cite: 132, 201].

---

## 📐 Board Layout & Rendering

[cite_start]The design features an onboard potentiometer (R2) for display contrast adjustment (V0) and dedicated protection components for the keyboard input[cite: 245].
...
## 📂 Related Modules
* 🏗️ **[Backplane System](https://github.com/Boogs77/BO6502/blob/main/BO6502%20BACKPLATE/README.md)**: 39-pin bus support.
